    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name=DB_table_name+'.csv'
                with open("Attendance/Manually Attendance/"+csv_name, "w") as csv_file:
                ...
                with open("Attendance/Manually Attendance/"+csv_name, newline="") as file:
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer "D:\Rahul Desai\Documents\Internship\Attendance System\Attendance"')
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if (conf <70):
                            ...
                            cv2.putText(im, str(tt), (x + h, y), font, 1, (0, 25, 255), 3)
                    if time.time() > future:
                        break
